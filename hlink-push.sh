...
./hlink -c $config /mnt/disk2/Downloads/ /mnt/disk2/hlink2/ > $log/log.txt             #自行修改硬链接路径
bash $push/push.sh
./hlink -c $config /mnt/disk3/Media/ /mnt/disk3/hlink3/ > $log/log.txt                 #自行修改硬链接路径(如果路径不够，复制粘贴即可)
bash $push/push.sh
